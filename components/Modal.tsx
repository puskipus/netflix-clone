  ...
  return (
    <MuiModal
      ...
      className="fixed !top-7 left-0 right-0
        z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll
    ...
    >
      <>
        ...
        top-5 !z-40 h-9 w-9 border-none bg-[#181818] hover:bg-[#181818]"
        >
          ...
          >
            <div className="flex space-x-2">
              <button
                ...
                px-8 text-xl font-bold text-black transition 
                hover:bg-[#e6e6e6]"
              >
                <FaPlay className="h-10 w-7 text-black" />
                Play
              </button>

              <button className="modalButton h-10 w-10">
                <PlusIcon />
              </button>
            ...
            <button className="modalButton" onClick={() => setMuted(!muted)}>
              {muted ? <FaVolumeMute className="h-5 w-5" /> : <FaVolumeUp className="h-5 w-5" />}
            </button>
          </div>
        </div>
        ...
        <div className="flex space-x-16 rounded-b-md bg-[#181818] px-10 py-10">
          <div className="space-y-6 text-lg">
            ...
            <div className="flex flex-col pr-5 gap-x-10 gap-y-4 font-light text-justify md:flex-row">
              <p>{movie?.overview}</p>
